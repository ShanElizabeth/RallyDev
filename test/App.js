Ext.define('CustomApp', {
    ...
    _addStoryPanel: function(storyRecord, blockedRevision) {
      ...
      storyTemplate = new Ext.Template('<span style="float:left;padding-left:20px;margin-top:10px;margin-bottom:5px">\
        <b><a href={ID_URL} target="_parent">{formattedID}</a></b><p style="padding-left:400px;float:right;">{storyName} </p><br> \
\
